 ...
 *  04.03.00   2016-01-12  ASe     ESCAN00087395    Added tag for presence pattern types
 *  04.04.00   2016-03-07  MVi     ESCAN00088647    Missing prototype (Vag)
 *                                 ESCAN00088763    Added ApplFblIsValidBlock
 *                                 ESCAN00088771    Rework ApplFblWriteCRCTotal
 ...
 *  04.06.00   2016-08-24  Rie     ESCAN00091648    No changes
 *  04.07.00   2017-01-05  Ach     ESCAN00093448    Improve compatibility with SecMod generator modules
 *  04.08.00   2017-03-06  JHg     ESCAN00094275    No changes
...
#if ( FBLKBAPI_FRAMENV_UDS1_VERSION != 0x0409u ) || \
...
# endif /* FBL_APPL_ENABLE_STARTUP_DEPENDENCY_CHECK */

   {
      ...
      if (result == kFblOk)
      {
         result = (tFblResult)ApplFblNvWriteFingerprint(blockDescriptor.blockNr, &blockFingerprint[0]);
      }
   }
